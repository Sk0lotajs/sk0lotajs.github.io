const questions = {
    ...
    6: [
    {type: "info", 
    content: "https://www.sahafederacija.lv/"}
    ],
    7: [
    {type: "info",
    content: "asd"
    ...
    13: [
    {type: "info", content: "Feliz Navidad!"}
    ],
    14: [
    {type: "info", content: "Buon Natale!"}
    ],
    2: [
    ...
    12: [
    {type: "info", content: "[MAZĀ DĀVANIŅA SKOLAI] Tavs uzdevums ir atrast un izdomāt vienu lietu, ko tu šodien vari 'uzdavināt skolai', piemēram, sakopt kādu telpu, palīdzēt kādam klasesbiedram, izveidot plakātu vai zīmējumu u.tml. Kad esi izpildījis uzdevumu, pastāsti par to matemātikas skolotājam. Šajā aktivitātē ir iespēja tikt pie papildus balvām!"}
    ],
    17: [
