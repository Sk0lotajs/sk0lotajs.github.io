const questions = {
    ...
    2: [
    { type: "choice",
    question: "Kas tev palīdz koncentrēties mācību laikā?",
    ...
    4: [
    { type: "choice",
    question: "Ko tu parasti dari, ja nesaproti tēmu no pirmās reizes?",
    ...
    5: [
    { type: "choice",
    question: "Kas tev palīdz neatlikt mājasdarbus?",
    options: ["Termiņa tuvošanās", "Interese par tēmu", "Vecāku atbalsts", "Laika plānošana", "Mūzika/motivācija"] },
    { type: "choice",
    question: "Kā tev ērtāk saņemt skolotāja komentārus?",
